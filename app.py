...
def metrics():
    ...
    model_prediction_success_rate = round(random.uniform(10, 100), 2) # Success rate in %

    # Return metrices in prometheus format
    prometheus_metrics = (
...
def index():
    return jsonify({"message": "Welcome to Flask metrics APP! /metrics for Prometheus metrics."})
